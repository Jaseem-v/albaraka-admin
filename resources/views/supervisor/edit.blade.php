...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Edit Supervisor</h4>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('supervisor.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <select class="form-control select" name="status">
                                <option value="1" {{ old('status',$user->active == 1 ? 'selected' : '') }}>Active</option>
                                <option value="0" {{ old('status',$user->active == 0 ? 'selected' : '') }}>Inactive</option>
                            </select>
                            @error('status')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-2 mt-5">
                            <input type="submit" value="Update Supervisor" class="btn btn-primary form-control">
                        </div>
                    </div>
                </form>
            </div>
